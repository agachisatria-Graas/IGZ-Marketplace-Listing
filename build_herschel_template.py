...
HERSCHEL_RAW_COLUMNS = [
    ...
    ("material", "Material", "Free text, one point per line (paste your full bullet list here if you like) — the tool automatically picks out the first recognizable material keyword (e.g. Polyester, Leather, Nylon) to use in Shopee/Lazada/Zalora's Material fields.", "Custom print inspired by the worlds of Minecraft\n100% recycled 600D polyester, excluding trims"),
    ...
    ("tiktok_item_specifications", "TikTok Item Specifications", "'Key=Value' pairs separated by ' ; '. Written to generic Specification columns — TikTok's real template needs these under specific attribute-ID columns per category, so copy them over manually before uploading.", "Capacity=25L"),
    ("zalora_subcat_type", "Zalora Sub Cat Type", "", "Backpacks"),
    ("zalora_color_family", "Zalora Color Family", "", "Black"),
    ("zalora_color", "Zalora Color", "", "Black"),
