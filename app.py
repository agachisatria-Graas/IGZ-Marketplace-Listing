...
# ===========================================================================
# Toms tool — fully separate raw data format, category matching rule (a
# THIRD, hybrid rule: title keywords + exact Specific Category), and mapping
# logic (toms_mapping.py). Kept apart from Hydro Flask's and Herschel's
# constants/functions above on purpose.
# ===========================================================================
